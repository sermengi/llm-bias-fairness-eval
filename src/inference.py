...
class ModelInferencePipeline:
    ...
    def _aggregate_results(self):
        ...
        output_dir = artifact_config.artifacts_root
        predictions_folder_path = artifact_config.predictions_folder_path
        ...
        df.to_csv(predictions_folder_path, index=False)
        logger.info(f"Results saved to {predictions_folder_path}")
